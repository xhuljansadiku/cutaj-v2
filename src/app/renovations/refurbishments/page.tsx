...
export const metadata: Metadata = {
  title: 'Full Home Refurbishment London | House Renovation Specialists | Cutaj',
  description:
    'Complete home refurbishment specialists in London. One project manager, all trades, fixed price. Victorian terraces to modern flats — we handle everything.',
  alternates: { canonical: 'https://cutajconstruction.co.uk/renovations/refurbishments' },
}

const service = getServiceBySlug('refurbishments')!
const projects = getProjectsByCategory('refurbishment')
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Full Home Refurbishments', href: '/renovations/refurbishments' },
        ]}
      />
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src={service.image}
            alt="Full home refurbishment London by Cutaj"
            fill
        ...
        <div className="relative z-10 section-px">
          ...
          <h1 className="text-display font-display font-bold text-white mb-4 max-w-2xl">
            Full Home Refurbishments London
          </h1>
          <p className="text-white/75 text-lg max-w-xl mb-8">
            Complete home transformations from start to finish. One project manager. One point
            of contact. Zero stress.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Button href="/contact" size="lg" className="bg-[var(--color-gold)] hover:bg-[var(--color-gold-dark)] text-white">
              Get a Free Quote
            </Button>
            <a href="tel:07908787037" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold text-sm rounded-md border border-white/20 transition-all duration-200 backdrop-blur-sm">
              Call 07908 787 037
            </a>
          </div>
        </div>
            ...
            <div>
              ...
              {service.startingFrom && (
                <div className="mt-6 inline-block bg-[var(--color-gold)]/10 border border-[var(--color-gold)]/20 rounded-lg px-5 py-3">
                  ...
                  <div className="text-xs text-[var(--color-neutral-600)]">Full project. Fixed price.</div>
                </div>
              )}
            </div>
      ...
      {projects.length > 0 && (
        <section className="section-py bg-[var(--color-off-white)]">
          <div className="section-px">
            <SectionLabel>Our Refurbishment Projects</SectionLabel>
            <h2 className="text-heading font-display font-bold text-[var(--color-primary)] mb-10">
              Recent Home Refurbishments
            </h2>
