...
const faqs = [
  ...
  { q: 'How do I get started?', a: "Simply request a free quote using the form on this page, or call us directly on 020 1234 5678. We'll arrange a free site visit at a time that suits you, take measurements and provide a full written quote within 48 hours." },
      ...
      <div className="section-px">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
          <div>
            ...
            <a href="tel:02012345678" className="text-sm font-semibold text-[var(--color-gold-dark)] hover:text-[var(--color-gold)] transition-colors">
              020 1234 5678 →
            </a>
          </div>
