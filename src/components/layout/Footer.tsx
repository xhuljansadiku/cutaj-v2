      ...
      <div className="section-px py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <div className="text-2xl font-display font-bold tracking-[0.08em]">CUTAJ</div>
              <div className="text-xs tracking-[0.2em] uppercase text-[var(--color-gold)] mt-0.5">Renovations</div>
            </div>
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              London&apos;s trusted renovation specialists. We transform homes with precision,
              craftsmanship and care. Fully insured. Fixed price quotes.
            </p>
